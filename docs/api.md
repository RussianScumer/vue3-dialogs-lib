...
- [Closing, and guards](#closing-and-guards)
- [Window results](#window-results)
- [Inside a window's content](#inside-a-windows-content)
- [Typed `open()`](#typed-open)
- [Contract for consumers](#contract-for-consumers)
